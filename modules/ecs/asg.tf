...
#   resource_id        = "service/${aws_ecs_cluster.ecs.name}/${aws_ecs_service.ecs_svc_fe.name}"
#   scalable_dimension = "ecs:service:DesiredCount"
#   min_capacity       = 2
#   max_capacity       = 4

#   depends_on = [aws_ecs_service.ecs_svc_fe]
# }
...
#     ServiceName = aws_ecs_service.ecs_svc_fe.name
#   }
